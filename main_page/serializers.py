...
class HistoryStepSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = HistoryStep
        fields = ['id', 'year', 'title', 'description', 'buildings', 'students', 'programs', 'achievements']
    ...
    def get_achievements(self, obj):
        ...
        return obj.achievements_ru if language == 'ru' else obj.achievements_en if language == 'en' else obj.achievements_ky
