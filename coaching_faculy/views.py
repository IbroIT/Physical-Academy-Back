        ...
        return Response(
            {
                ...
                "about": reverse(
                    "coaching_faculty:about", request=request, format=format
                ),
                "management": reverse(
                    "coaching_faculty:management", request=request, format=format
                ),
                "specializations": reverse(
                    "coaching_faculty:specializations", request=request, format=format
                ),
                "departments": reverse(
                    "coaching_faculty:departments", request=request, format=format
                ),
            }
        )
...
class CoachingFacultyAboutAPIView(APIView):
...
class CoachingFacultyManagementAPIView(APIView):
...
class CoachingFacultySpecializationsAPIView(APIView):
...
class CoachingFacultyDepartmentsAPIView(APIView):
