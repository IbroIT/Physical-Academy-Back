...
class FacultyTeachersSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'photo', 'full_name', 'position', ]
...
class FacultyProgramsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'emoji', 'name', 'degree', 'description', 'duration_years', 'offline', 'tuition_fee']
...
class FacultySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Faculty
        fields = [
            'name', 'description', 'mission', 'achievements',
            'statistics', 'programs', 'specializations', 'sports', 'teachers', 'contacts'
        ]
