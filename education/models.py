...
class PhdPrograms(models.Model):
    ...
    name_kg = models.CharField(max_length=100, verbose_name="Название (KY)")
    name_en = models.CharField(max_length=100, verbose_name="Название (EN)")

    description_ru = models.TextField(verbose_name="Описание (RU)")
    description_kg = models.TextField(verbose_name="Описание (KY)")
    ...
    features_kg = models.JSONField(
        verbose_name="Особенности (KY)", default=list, null=True, blank=True
    )
...
class MasterPrograms(models.Model):
    ...
    features_kg = models.JSONField(verbose_name="Особенности (KY)")
...
class FacultyStatistics(models.Model):
    ...
    meaning_kg = models.CharField(max_length=100, verbose_name="Значение (KY)")
...
class FacultyTeachers(models.Model):
    ...
    full_name_kg = models.CharField(max_length=100, verbose_name="Полное имя (KY)")
    ...
    position_kg = models.CharField(max_length=100, verbose_name="Должность (KY)")
...
class FacultyContacts(models.Model):
    ...
    title_kg = models.CharField(max_length=100, verbose_name="Заголовок (KY)")
...
class Faculty(models.Model):
    ...
    mission_kg = models.JSONField(verbose_name="Миссия (KY)")
    mission_en = models.JSONField(verbose_name="Миссия (EN)")

    achievements_ru = models.JSONField(verbose_name="Достижения (RU)")
    achievements_kg = models.JSONField(verbose_name="Достижения (KY)")
