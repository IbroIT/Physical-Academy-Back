...
# Import admin configurations from admin subpackage
from .admin.contact_social import *
from .admin.disabilities import *
from .admin.scholarship_visa import *
from .admin.council import *
...
class ClubAdmin(admin.ModelAdmin):
    ...
    inlines = [ClubLeaderInline, ClubMembershipInline]
    ...
    fieldsets = (
        ...
        ("Цели и задачи", {"fields": ("goals_ru", "goals_en", "goals_kg")}),
        ("Мотивация", {"fields": ("motivation_ru", "motivation_en", "motivation_kg")}),
        (
            "Расписание встреч",
            {"fields": ("meetings_ru", "meetings_en", "meetings_kg")},
        ),
        ("Дополнительно", {"fields": ("tags",)}),
    )
...
class ClubLeaderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Основная информация", {"fields": ("club", "photo", "order")}),
        ("ФИО", {"fields": ("name_ru", "name_en", "name_kg")}),
        ("Роль/Должность", {"fields": ("role_ru", "role_en", "role_kg")}),
...
class ClubStatsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Основная информация", {"fields": ("value", "icon", "order", "is_active")}),
        ("Метка", {"fields": ("label_ru", "label_en", "label_kg")}),
    )
...
class StudentProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("ФИО", {"fields": ("full_name_ru", "full_name_en", "full_name_kg")}),
        (
            "Учебная информация",
            {
                "fields": (
        ...
        ("О себе", {"fields": ("bio_ru", "bio_en", "bio_kg")}),
        ("Дополнительно", {"fields": ("interests", "photo")}),
    )
...
class ClubMembershipAdmin(admin.ModelAdmin):
    ...
    search_fields = ["student__full_name_ru", "club__name_ru"]
    readonly_fields = ["joined_at", "updated_at"]

    fieldsets = (
        ("Основная информация", {"fields": ("student", "club", "status")}),
        ("Роль в клубе", {"fields": ("role_ru", "role_en", "role_kg")}),
        (
            "Дополнительно",
            {"fields": ("motivation_text", "joined_at", "updated_at")},
        ),
    )
