...
class Announcement(models.Model):
    ...
    image = models.ImageField(upload_to='announcements/', verbose_name=_("Изображение"))
    urgency = models.CharField(max_length=10, choices=URGENCY_LEVELS, default='low', verbose_name=_("Срочность"))
